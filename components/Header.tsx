    ...
    <>
      ...
      <header className="site-header">
        <div className="shell header-inner">
          <Link className="brand" href="/" aria-label="Sitora home"><span className="brand-mark">S</span><span><strong>Sitora</strong><small>Healthcare Resource Intelligence</small></span></Link>
