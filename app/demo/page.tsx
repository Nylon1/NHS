    ...
    <>
      <section className="page-head">
        <div className="shell">
          ...
          <p className="lede">
            Choose one of the two flagship workflows. Both prototypes use fictional data to demonstrate the proposed decision logic, governance and Resource Recovery Record.
          </p>
        </div>
      </section>
